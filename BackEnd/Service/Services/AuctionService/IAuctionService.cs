...
namespace Service.Services.AuctionService
{
    public interface IAuctionService
    {
        ...
        Task CancelAuctionAsync(Guid auctionId, Guid sellerId);
        ...
        Task<Guid> CheckoutWonAuctionAsync(Guid auctionId, Guid userId, string receiverName, string receiverPhone, string shippingCity, string shippingAddress, string paymentMethod);
    }
